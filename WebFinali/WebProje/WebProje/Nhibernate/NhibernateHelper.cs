    ...
    public class NhibernateHelper
    {
        ...
        private static ISessionFactory SessionFactory
        {
            get
            {
                if (_sessionFactory == null)
                {
                    ...
                    configuration.AddDeserializedMapping(mapping, "kitap");
        ...
        public static Configuration ConfigureNhibernate()
        {
            ...
            configure.DataBaseIntegration(db =>
            {
                ...
                db.ConnectionString = "Data Source=DESKTOP-BNGLB0I\\SQLEXPRESS;Initial Catalog=kitap;User ID=smsm;Password=Jt17";
        ...
        protected static HbmMapping GetMappings()
        {
            ...
            mapper.AddMapping<Models.KitapMap>();
            mapper.AddMapping<Models.YazarMap>();
